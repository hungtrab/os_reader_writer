...
\title{OS Project}
\subtitle{Topic 6. The Reader-Writer Problem}
\author{Tran Quang Hung 20235502\\
Nguyen Xuan Khai 20235508}
\institute{\large Hanoi University of Science and Technology\\
Supervisor: PhD. Do Quoc Huy}
\date{\today}

% Custom footline - Reader-Writer Problem in bottom left
\setbeamertemplate{footline}
{
  \leavevmode%
  \hbox{%
  \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.25ex,dp=1ex,left]{author in head/foot}%
    \hspace*{2ex}\usebeamerfont{author in head/foot}Reader-Writer Problem
  \end{beamercolorbox}%
...
\begin{frame}[c] % [c] centers content vertically
    \centering   % centers content horizontally
    
    {\Huge \textbf{INTRODUCTION}} % \Huge makes it big, \textbf makes it bold
...
\begin{frame}[c] % [c] centers content vertically
    ...
    {\Huge \textbf{IMPLEMENTATION}} % \Huge makes it big, \textbf makes it bold

\end{frame}

\begin{frame}{Demonstration}
    \centering
    \includegraphics[width=\textwidth]{media/predefined_sentences.png}
\end{frame}

\begin{frame}{Demonstration}
    \centering
    \includegraphics[width=\textwidth]{media/error.png}
\end{frame}
...
\begin{frame}[c] % [c] centers content vertically
    ...
    {\Huge \textbf{SYNCHRONIZATION MODES}} % \Huge makes it big, \textbf makes it bold
...
\begin{tabular}{|l|c|c|}
\hline
\textbf{Mode} & \textbf{Correctness} & \textbf{Starvation} \\ \hline
Vanilla & \alert{\textbf{NO}} & N/A \\ \hline
Reader Pref & \textcolor{green!50!black}{YES} & Writers \\ \hline
Writer Pref & \textcolor{green!50!black}{YES} & Readers \\ \hline
Fair & \textcolor{green!50!black}{YES} & \textcolor{green!50!black}{None} \\ \hline
\end{tabular}
\end{table}
...
\begin{frame}[c] % [c] centers content vertically
    ...
    {\Huge \textbf{EXPERIMENTAL RESULTS}} % \Huge makes it big, \textbf makes it bold
...
\begin{frame}[c] % [c] centers content vertically
    ...
    {\Huge \textbf{CONCLUSION}} % \Huge makes it big, \textbf makes it bold
